...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <div className="font-poppins text-xl text-wrap py-8 md:px-32 px-6 flex flex-col md:flex-row w-fit items-center justify-between gap-10  md:gap-0">
        <div>
          <h1 className="text-3xl">Featured Projects and Contributions</h1>
        </div>
